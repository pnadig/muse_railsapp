...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { division: @dashboard.division, product: @dashboard.product, title: @dashboard.title }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { division: @dashboard.division, product: @dashboard.product, title: @dashboard.title }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
